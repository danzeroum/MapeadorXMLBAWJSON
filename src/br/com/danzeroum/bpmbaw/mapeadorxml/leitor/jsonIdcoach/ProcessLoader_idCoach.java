// Local: src/br/com/danzeroum/bpmbaw/mapeadorxml/leitor/ProcessLoader.java
...
import br.com.danzeroum.bpmbaw.mapeadorxml.modelo.cv.ConfigOption;
import br.com.danzeroum.bpmbaw.mapeadorxml.modelo.cv.InlineScript;
...
import br.com.danzeroum.bpmbaw.mapeadorxml.modelo.process.ParameterMapping;
...
import br.com.danzeroum.bpmbaw.mapeadorxml.modelo.process.SwitchCondition;
...
import br.com.danzeroum.bpmbaw.mapeadorxml.modelo.twclass.Definition;
...
public class ProcessLoader_idCoach {
    ...
    public ProcessLoader_idCoach(String twxDirectoryPath, PrintWriter logger) throws Exception {
    ...
    private JAXBContext getUniversalJaxbContext() throws Exception {
        if (universalJaxbContext == null) {
            logger.println("[LOG-JAXB] Inicializando JAXBContext universal com lista explícita de classes...");
            ...
            logger.println("[LOG-JAXB] JAXBContext universal criado com sucesso.");
        }
    ...
    // O resto da classe pode permanecer igual
        ...
        if (tw.getProcess() != null) {
            ...
            if (tw.getProcess().getItems() != null) {
                tw.getProcess().getItems().stream()
                        ...
                        .map(TWComponent::getAttachedProcessRef)
    ...
    private void collectCallActivities(List<Object> elements, Set<String> ids) {
        ...
        for (Object el : elements) {
            if (el instanceof CallActivity) {
                ...
                if (calledElement != null && !calledElement.isEmpty()) ids.add(calledElement);
    ...
    public static class ArtifactLocation {
        final PackageObject objectInfo;
