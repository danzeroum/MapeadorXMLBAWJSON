...
public class JsonParticipantNavigator_idCoach {

    private final JsonReportGenerator_idCoach generator;
    private final ProcessLoader_idCoach loader;

    public JsonParticipantNavigator_idCoach(JsonReportGenerator_idCoach generator, ProcessLoader_idCoach loader) {
