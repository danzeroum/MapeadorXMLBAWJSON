...
public class JsonEnvironmentNavigator_idCoach {

    private final JsonReportGenerator_idCoach generator;
    private final String rootDirectoryPath;

    public JsonEnvironmentNavigator_idCoach(JsonReportGenerator_idCoach generator, String rootDirectoryPath) {
    ...
    private void transformToReport(EnvironmentVariableSet envSet) {
        ...
        if (envSet.getEnvVars() != null) {
            for (br.com.danzeroum.bpmbaw.mapeadorxml.modelo.envar.EnvironmentVariable envVar : envSet.getEnvVars()) {
                ...
                jsonVar.setName(envVar.getName());
