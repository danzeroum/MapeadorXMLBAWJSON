...
public class JsonResourceBundleNavigator_idCoach {

    private final JsonReportGenerator_idCoach generator;
    private final String rootDirectoryPath;

    public JsonResourceBundleNavigator_idCoach(JsonReportGenerator_idCoach generator, String rootDirectoryPath) {
